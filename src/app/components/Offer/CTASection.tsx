...
export default function CTASection() {
  return (
    <div className="mx-auto max-w-4xl px-4 text-center">
      <h3 className="my-5 mb-3 text-xl font-bold text-gray-900 sm:text-2xl md:text-3xl">
        Gotowy na oszczędności?
      </h3>

      <p className="mx-auto mb-8 max-w-xl px-4 text-base leading-relaxed text-gray-600 sm:text-md md:text-md">
      ...
      <div className="mx-auto mb-8 flex max-w-sm flex-col gap-3">
        ...
        >
          <span className="text-sm">Umów bezpłatną konsultację</span>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <Phone className="h-4 w-4 text-gray-600 group-hover:text-blue-500" />
            <span className="font-semibold text-gray-700 group-hover:text-blue-500 text-xs">
              Zadzwoń
            </span>
          </a>
          ...
          <a
            ...
            className="group flex items-center justify-center gap-2 rounded-full border-2 border-gray-200 bg-white px-4 py-3.5 transition-all active:scale-95 hover:border-blue-500"
          >
            <Mail className="h-4 w-4 text-gray-600 group-hover:text-blue-500" />
            <span className="font-semibold text-gray-700 group-hover:text-blue-500 text-xs">
              Email
            </span>
          </a>
