  ...
  return (
    <div className="absolute inset-0 backface-hidden">
      <div className="bg-white rounded-3xl overflow-hidden border border-gray-300 shadow-lg h-full">
        <div className="relative bg-linear-to-br from-blue-500 to-cyan-500 h-52 flex items-center justify-center">
        ...
        <div className="p-6">
          ...
          <p className="text-xs text-gray-600 text-center leading-relaxed line-clamp-2 mb-4">
            {product.description}
          </p>
