...
export const contacts: SocialContact[] = [
  {
    ...
    description:
      "Dołącz do społeczności – codzienna dawka inspiracji i kulis mojej pracy.",
  ...
  },
  {
    ...
    description:
      "Aktualne programy, zmiany w dotacjach i szybki kontakt w jednym miejscu.",
  ...
  },
  {
    ...
    description:
      "Zobacz wideo poradniki krok po kroku – praktyczne wskazówki bez teorii.",
  ...
  },
  {
    ...
    description:
      "Szybkie tipy i ciekawostki o OZE w lekkiej i przystępnej formie.",
