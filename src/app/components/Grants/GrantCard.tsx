...
export default function GrantCard({
  ...
  return (
    <motion.div
      ...
      className="relative h-full min-w-[88%] sm:min-w-[80%] md:min-w-0 snap-center"
    >
      ...
      <div className={`group flex flex-col h-full min-h-125 md:min-h-0 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all overflow-hidden border-2 ${
        grant.recommended 
          ? "border-yellow-400" 
